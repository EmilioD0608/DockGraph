...
import { LucideAngularModule, ChevronLeft, ChevronRight, Plus, Trash2, Save, Link, ArrowRight, Settings, GitBranch, LayoutTemplate, Folder } from 'lucide-angular';
...
export class LeftPanelComponent implements OnInit {
    ...
    isOpen = signal(true);
    activeTab = signal<'relations' | 'settings' | 'templates' | 'projects'>('relations');
    ...
    selectTab(tab: 'relations' | 'settings' | 'templates' | 'projects') {
        if (tab === 'projects' && !this.isLoggedIn) {
